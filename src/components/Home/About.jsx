            ...
            <Row>
              <Col md={8} className="home-about-description">
                ...
                <p className="home-about-body">
                 Hi, my name is <span className="yellow">KARUNESH KUMAR SINGH</span>
            ...
            <Row>
              <Col md={12} className="home-about-social">
                ...
                <ul className="home-about-social-links">
                  ...
                  <li className="social-icons">
                    <a
                      href="https://www.linkedin.com/in/karunesh-kumar-singh-b86444227/"
                      target="_blank"
                      rel="noreferrer"
                      className="icon-colour  home-social-icons"
                      aria-label="linkedin"
                  ...
                  <li className="social-icons">
                    <a
                      href="https://www.instagram.com/thekksingh29/?hl=en"
                      target="_blank"
                      rel="noreferrer"
                      className="icon-colour home-social-icons"
